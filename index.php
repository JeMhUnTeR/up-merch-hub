...
<html>
<head>
	<title>UP Merchandise Hub</title>
	...
	<div id="body">
		<div class="vwrap">
			...
			<?php
				...
				$itemlist = get("SELECT * FROM items NATURAL JOIN orgs HAVING (SELECT POSITION('$s' in item_name) OR POSITION('$s' in item_description) OR POSITION('$s' in item_price) OR POSITION('$s' in item_categories) OR POSITION('$s' in org_name)) ORDER BY `$o`, `item_name`");
